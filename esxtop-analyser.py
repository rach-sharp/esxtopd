...
def get_esx_top_header(filename):
...
# Print esxtop header
def print_esx_top_header():
    for item in dictionary_header:
        print(item)


# Print esxtop data
def print_esx_top_data_for_analysis():
    print("\"Date-time\",", end=' ')
...
def print_counters_for_analysis():
    i = 0
    for counter in array_counters_to_analyse:
...
def print_esx_top_bundle_stats():
...
def get_esx_top():
    ...
    get_esx_top_header(file_header)
